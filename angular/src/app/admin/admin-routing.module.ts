...
import { AddAuditBudgetComponent } from '@app/admin/audits/add-audit-budget/add-audit-budget.component';
        ...
        RouterModule.forChild([
            {
                ...
                children: [
                    ...
                    { path: 'audits', component: AuditsComponent, data: { permission: 'Pages.Administration.Users' } },
                    { path: 'add_audit', component: AddAuditBudgetComponent, data: { permission: 'Pages.Administration.Users' } },
